function Cap(width, depth){
  ...
  this.mesh.material.materials[0] = new THREE.MeshPhongMaterial( { color: colors.exterior, morphTargets: true, vertexColors: THREE.FaceColors, shading: THREE.FlatShading } );
  ...
  this.mesh.material.materials[2] = new THREE.MeshPhongMaterial( { color: colors.floor, morphTargets: true, vertexColors: THREE.FaceColors, shading: THREE.FlatShading } );
