...
var block_files = {
  ...
  wo_i_300: {type:"wo_i_300", model:'models/wo_i_300.json',   type_class:Wall,     price:640,    mt:[1]     },
  wo_i_600: {type:"wo_i_600", model:'models/wo_i_600.json',   type_class:Wall,     price:640,    mt:[1]     },
  wo_w_600: {type:"wo_w_600", model:'models/wo_w_600.json',   type_class:Wall,     price:640,    mt:[1]     },
  wo_w_900: {type:"wo_w_900", model:'models/wo_w_900.json',   type_class:Wall,     price:640,    mt:[1]     },
  wo_d_900: {type:"wo_d_900", model:'models/wo_d_900.json',   type_class:Wall,     price:640,    mt:[1]     },
